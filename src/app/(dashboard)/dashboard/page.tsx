...
function buildDailyPnl(closedTrades: any[]) {
  ...
  for (const t of closedTrades) {
    const date = (t.closedAt ?? t.openedAt).toISOString().split('T')[0]
    const pnl = Number(t.netPnl ?? 0)
    ...
    <div className="space-y-6">
      ...
      <div>
        ...
        <p className="text-muted-foreground mt-1">
          Here's your trading overview for the past 30 days
        </p>
      </div>
        ...
        <div className="lg:col-span-2 bg-card border border-border rounded-xl p-6">
          <div className="flex items-center justify-between mb-4">
            <div>
              ...
              <p className="text-xs text-muted-foreground">Cumulative performance this month</p>
            </div>
          </div>
          <div className="h-56">
